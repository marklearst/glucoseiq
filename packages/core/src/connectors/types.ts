...
export interface LibreLinkUpEntry {
  /** Glucose value in the account's display unit (see GlucoseUnits) */
  Value: number
  /** Glucose value in mg/dL, when provided by the API (preferred) */
  ValueInMgPerDl?: number
  /** Display unit flag: 1 = mg/dL, 0 = mmol/L */
  GlucoseUnits?: 0 | 1
