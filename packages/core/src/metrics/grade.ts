 ...
 *
 * Values <= 0 are skipped. Readings default to mg/dL; pass `unit: 'mmol/L'`
 * to have them converted to mg/dL first. The partition thresholds are always
 * expressed in mg/dL.
 *
 ...
 * @param hypoThreshold - Upper bound for hypoglycemia (default: 70 mg/dL, always mg/dL)
 * @param hyperThreshold - Lower bound for hyperglycemia (default: 140 mg/dL, always mg/dL)
