---
title: Testing
description: Generate repeatable CGM series and scenario fixtures with @glucoseiq/testing.
---
...
so they can go directly into reading-based analytics such as `analyzeGlucose`:
...
<Callout type="warn" title="Synthetic data is not clinical validation">
  These fixtures are designed for repeatable software testing and visual
