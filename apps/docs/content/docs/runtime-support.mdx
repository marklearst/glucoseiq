...
The repository compiles documentation examples with TypeScript 5.9.3. Older
...
React, tokens, testing, and the CLI each publish one root entrypoint. Import
only documented entrypoints; internal source paths and private build chunks are
...
- GlucoseIQ requires Node 24 or newer.
