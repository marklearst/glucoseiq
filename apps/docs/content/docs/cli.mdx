---
title: CLI
description: Analyze CGM CSV files from the command line without application code.
---

Point the CLI at header-row delimited data, map its timestamp and glucose-value
columns, and print a CGM analytics summary without writing application code:
