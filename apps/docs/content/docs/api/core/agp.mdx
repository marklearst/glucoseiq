...
Calculates the fields in [AGPMetricsResult](/docs/api/core/types#agpmetricsresult) from glucose readings.

Other public metrics remain available through their own functions.

**Returns:** An [AGPMetricsResult](/docs/api/core/types#agpmetricsresult) with the calculated fields
