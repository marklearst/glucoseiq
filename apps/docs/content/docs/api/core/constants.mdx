...
```ts fragment="generated API declaration or signature"
const GMI_COEFFICIENTS: { readonly A1C_INTERCEPT: 3.31; readonly A1C_SLOPE: 0.02392; readonly MG_DL_INTERCEPT: 3.31; readonly MG_DL_SLOPE: 0.02392; readonly MMOL_L_INTERCEPT: 3.31; readonly MMOL_L_SLOPE: 0.430995344 }
```
