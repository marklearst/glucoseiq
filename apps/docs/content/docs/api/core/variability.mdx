...
**Remarks:** Returns NaN when readings contain fewer than 2 values or their mean is 0.
...
**Remarks:** Returns NaN when readings contain fewer than 2 values. NaN and Infinity
