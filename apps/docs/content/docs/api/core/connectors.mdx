...
```ts fragment="generated API declaration or signature"
normalizeDexcomTrend(trend: DexcomTrendString | string & {} | null | undefined): CGMTrend
```
...
```ts fragment="generated API declaration or signature"
normalizeLibreTrend(trend: number | null | undefined): CGMTrend
```
...
```ts fragment="generated API declaration or signature"
normalizeNightscoutDirection(direction: NightscoutDirection | undefined): CGMTrend
```
