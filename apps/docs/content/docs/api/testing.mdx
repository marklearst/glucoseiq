---
title: Testing API
description: Public generator options and repeatable scenarios exported by @glucoseiq/testing.
---
...
The generator returns chronological readings. The same options and seed produce
the same output.
